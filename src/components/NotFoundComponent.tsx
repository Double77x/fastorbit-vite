          ...
          kicker={
            <div className='relative mb-2'>
              ...
              <div className='absolute inset-0 flex items-center justify-center'>
                <div className='flex size-24 rotate-12 items-center justify-center rounded-3xl border border-primary/20 bg-primary/10 shadow-inner'>
                  <Search className='size-12 -rotate-12 text-primary' />
                </div>
              </div>
            </div>
          }

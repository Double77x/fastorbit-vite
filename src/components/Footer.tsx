...
import { FOOTER_LEGAL_LINKS, FOOTER_PRODUCT_LINKS, FOOTER_RESOURCES_LINKS } from "@/data/navigation";
        ...
        <div className='grid grid-cols-1 gap-10 lg:grid-cols-2'>
          ...
          <div>
            ...
            <p className='max-w-sm text-sm leading-relaxed text-muted-foreground'>
              A TanStack Start SSG starter on Cloudflare Pages — type-safe, fast, and free to clone.
            </p>
          ...
          <div className='grid grid-cols-2 gap-8 sm:grid-cols-3'>
            ...
            <div>
              <h3 className='mb-3 text-xs font-semibold tracking-widest text-muted-foreground uppercase'>Resources</h3>
              <ul className='space-y-2.5'>

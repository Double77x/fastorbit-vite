...
export function CommandPalette() {
  ...
  // 2. Define searchable items — single source in data/navigation.ts + weather + quick-start
  ...
  // 7. Global Keydown Handler when Open (ArrowDown, ArrowUp, Enter, Tab)
  useEffect(() => {
    if (!open) return;
  ...
  // 8. Custom global event listener for navbar search button
  useEffect(() => {
